...
| Architecture | File | Macs |
|--------------|------|------|
| Universal | `Rockxy-x.x.x-universal.dmg` | Apple Silicon and Intel |
| arm64 | `Rockxy-x.x.x-arm64.dmg` | Apple Silicon (M1, M2, M3, M4) |
| x86_64 | `Rockxy-x.x.x-x86_64.dmg` | Intel |
