...
Grab the latest release from [GitHub Releases](https://github.com/LocNguyenHuu/Rockxy/releases). Choose the Universal `.dmg` if you are unsure which architecture your Mac uses.
...
Open the **Errors** tab to see automatically grouped error patterns across HTTP 4xx/5xx responses and log-level errors.

Open the **Performance** tab to see latency percentiles, slow request detection, payload size tracking, and trend comparisons against previous sessions.
