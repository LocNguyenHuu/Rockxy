...
GitHub Actions workflow (manual dispatch with optional channel parameter) — canonical file: [`.github/workflows/build.yml`](https://github.com/LocNguyenHuu/Rockxy/blob/main/.github/workflows/build.yml).
